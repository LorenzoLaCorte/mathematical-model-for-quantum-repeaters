...
The probability distribution of the total waiting time \( T_{n+1} \) for all attempts is given by Equation~\ref{eq:waiting_time_distillation}, which we restate here for convenience:
\begin{equation}
